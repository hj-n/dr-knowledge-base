...
- PENDING-REF-101-E7 | page: 1, section: extracted, quote: "We deﬁne the Minimum Reconstruction Error (MRE) from the embedding as E(Y/ X) := min A∈Rm×d ∥X− AY∥2 F, where∥·∥ F denotes the Frobenius norm.4 Note that PCA has the lowest possible MRE among all the DR methods."
