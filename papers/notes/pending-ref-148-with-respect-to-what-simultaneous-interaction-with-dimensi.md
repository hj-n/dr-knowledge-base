...
# Evidence
- PENDING-REF-148-E1 | page: 20, section: extracted, quote: "The Stagewise procedure has its potential generality as an a dvantage over LARS and Lasso: it is easy to deﬁne forward Stagewise methods for a wide variety of nonlinear ﬁtting problems, as in Hastie, Tibshirani and Friedman [(2001), Chapter 10, which begins with a Stagewise analysis of “boo sting”]."
- PENDING-REF-148-E2 | page: 16, section: extracted, quote: "Since one-at-a-time computations, perhaps with some added y jitter, apply to all practical situations, the LARS algorithm described in Section 7 is not equipped to handle many-at-a-time problems."
