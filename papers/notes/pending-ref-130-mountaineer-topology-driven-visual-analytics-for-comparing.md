...
- PENDING-REF-130-E6 | page: 1, section: extracted, quote: "Our motivation for employing this clustering method is that it 6 enables us to automatically select the appropriate parameter, as discussed in Section V-B, where we present our parameter selection strategy."
