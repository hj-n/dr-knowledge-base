---
id: paper-2004-pending-ref-184
title: "Principal Manifolds and Nonlinear Dimensionality Reduction via Tangent Space Alignment SIAM J"
authors: "REDUCTION VIA LOCAL T ANGENT SP ACE ALIGNMENT"
venue: "Journal of Shanghai University (English Edition)"
year: 2004
tags: [dr, reliability, visual_analytics, reference, pending_references]
source_pdf: papers/raw/pending-references/pending-ref-184-2004-principal-manifolds-and-nonlinear-dimensionality-reduction-via-tangent-space-alignmen.pdf
...
- CLAIM-PENDING-REF-184-C1 | stance: support | summary: Therefore, a natural way to approximate the global coordinate is to ﬁnd a global coordinate τ and a local aﬃne transformation Pτ that minimize the error function ∫ dτ ∫ Ω(τ ) ∥Pτ (¯τ−τ )−θ τ∥d¯τ .(3.3) This represents a nonlinear alignment approach for the dimension reduction problem (this idea will be picked up at the end of section 4). | evidence_ids: PENDING-REF-184-E1, PENDING-REF-184-E2
- CLAIM-PENDING-REF-184-C2 | stance: support | summary: The LTSA algorithm can be considered as an approach to ﬁnd an approximate solution to the above minimization probl em. | evidence_ids: PENDING-REF-184-E3, PENDING-REF-184-E4
- CLAIM-PENDING-REF-184-C3 | stance: support | summary: We need to investigate a proper formulation of the problem and t he related optimization methods. | evidence_ids: PENDING-REF-184-E5, PENDING-REF-184-E6
...
# Evidence
- PENDING-REF-184-E1 | page: 5, section: extracted, quote: "Therefore, a natural way to approximate the global coordinate is to ﬁnd a global coordinate τ and a local aﬃne transformation Pτ that minimize the error function ∫ dτ ∫ Ω(τ ) ∥Pτ (¯τ−τ )−θ τ∥d¯τ .(3.3) This represents a nonlinear alignment approach for the dimension reduction problem (this idea will be picked up at the end of section 4)."
- PENDING-REF-184-E2 | page: 1, section: extracted, quote: "Recently, there have been much renewed interests in develop ing eﬃcient algorithms for constructing nonlinear low-dimensional manifo lds from sample data points in high-dimensional spaces, emphasizing simple algorithm ic implementation and avoid- ∗ Department of Mathematics, Zhejiang University, Yuquan Ca mpus, Hangzhou, 310027, P."
- PENDING-REF-184-E3 | page: 2, section: extracted, quote: "The rest of the paper is organized as follows: in section 2, we formulate the problem of manifold learning and dimension reduction in mor e precise terms, and illustrate the intricacy of the problem using the linear cas e as an example."
- PENDING-REF-184-E4 | page: 3, section: extracted, quote: "Ot herwise, the learning problem becomes the well-researched nonlinear regression problem (for a more detailed discussion, see [4] where techniques from computational ge ometry was used to solve error-free manifold learning problems)."
- PENDING-REF-184-E5 | page: 8, section: extracted, quote: "The LTSA algorithm can be considered as an approach to ﬁnd an approximate solution to the above minimization probl em."
- PENDING-REF-184-E6 | page: 10, section: extracted, quote: "The lowdimensional embedding coordinate matrix computed by the LT SA algorithm is denoted by T = [ τ 1, . . . , τ N ]."
- PENDING-REF-184-E7 | page: 18, section: extracted, quote: "In this paper, we proposed a new algorithm (LTSA) for nonlinear manifold learning and nonline ar dimension reduction."
- PENDING-REF-184-E8 | page: 14, section: extracted, quote: "In this section, we present several numerical examples to illustrate the performance of our LTSA algorithm."
