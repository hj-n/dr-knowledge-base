...
NeRV is useful when you need explicit control over where neighborhood distortion is placed. This makes it valuable for task-conditioned tuning where local versus global error preference is known in advance.
