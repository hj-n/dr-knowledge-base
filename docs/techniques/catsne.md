...
## Recommended Library
Recommended library: **umap-learn (supervised approximation)**.
...
- catSNE reference code (Python source file): [https://github.com/via-cs/t-foresight/blob/main/backend/src/alg/catsne.py](https://github.com/via-cs/t-foresight/blob/main/backend/src/alg/catsne.py)
