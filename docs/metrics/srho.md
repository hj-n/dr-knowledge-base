...
However, high SRHO does not guarantee good local neighborhoods. Use SRHO as a global-order signal and require additional local checks for neighborhood/outlier tasks; otherwise ordering consistency can be mistaken for full structural reliability.
